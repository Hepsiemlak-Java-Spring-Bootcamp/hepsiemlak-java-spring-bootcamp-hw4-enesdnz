...
import emlakburada.repository.UserDataRepository;
...
public class EmailService {
	...
	public void send(String email, Integer id) {
	...
	private void saveDatabase(String email, Integer id)
	{
		UserData user = new UserData();
		user.setId(id);
		user.setEmail(email);
		userDataRepository.save(user);
		log.info("Mail ve kullanici veritabanina kaydedildi");
	}
